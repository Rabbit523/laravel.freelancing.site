...
*/
			...
			if("SUCCESS" == strtoupper($httpParsedResponseAr["ACK"]) || "SUCCESSWITHWARNING" == strtoupper($httpParsedResponseAr["ACK"])){
				...
				$msgType = $_SESSION["msgType"] = disMessage(array('type'=>'err','var'=>'Error : '.urldecode($httpParsedResponseAr["L_LONGMESSAGE0"])));
			...
			if(!empty($_SESSION['ppl_products'])&&!empty($_SESSION['ppl_charges'])){
				...
				if("SUCCESS" == strtoupper($httpParsedResponseAr["ACK"]) || "SUCCESSWITHWARNING" == strtoupper($httpParsedResponseAr["ACK"])){
					...
					if('Completed' == $httpParsedResponseAr["PAYMENTINFO_0_PAYMENTSTATUS"]){
						...
						include('../../units-sd/wallet-sd/return.php');
						//require_once DIR_MOD."wallet-sd/return.php";
					...
					elseif('Pending' == $httpParsedResponseAr["PAYMENTINFO_0_PAYMENTSTATUS"]){
						...
						$msgType = $_SESSION["msgType"] = disMessage(array('type'=>'suc','var'=>'<div style="color:red">Transaction Complete, but payment may still be pending! '.
						'If that\'s the case, you can manually authorize this payment in your <a target="_new" href="http://www.paypal.com">Paypal Account</a></div>'));
					...
					$msgType = $_SESSION["msgType"] = disMessage(array('type'=>'err','var'=>'<div style="color:red">Error : '.urldecode($httpParsedResponseAr["L_LONGMESSAGE0"])));
