...
if($action == "send_message")
{
	...
	$service_detail = $db->pdoQuery("select s.*,o.freelanserId,o.customerId from tbl_services As s
		LEFT JOIN tbl_services_order As o ON o.servicesId
		where o.id=? ",array($orderId))->result();
