<?php
	...
	require_once DIR_CLASS."freelancer_savedJobs-sd.lib.php";
	extract($_REQUEST);

	$winTitle = 'My Saved Jobs - ' . SITE_NM;
	$headTitle = 'My Saved Jobs';
	...
	$mainObj = new FreelancerSavedJobs($module,'','',$query_string);
