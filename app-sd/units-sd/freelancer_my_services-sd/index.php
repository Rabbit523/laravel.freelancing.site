<?php
	...
	require_once DIR_CLASS."freelancer_my_services-sd.lib.php";
	extract($_REQUEST);

	$winTitle = 'My Services - ' . SITE_NM;
	$headTitle = 'My Services';
	...
	$mainObj = new FreelancerMyServices($module,'','',$query_string);
