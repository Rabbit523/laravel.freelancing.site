...
include(DIR_ADMIN_CLASS."freelancer_constant-sd.lib.php");

$module = 'freelancer_constant-sd';
...
$mainObject = new FreelancerConstant($module, $id, $tab_name,NULL, $searchArray, $action);
