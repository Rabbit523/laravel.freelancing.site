<?php
	...
	if ($action == "updateStatus" && in_array('status', $Permission)) {
		...
		if (isset($id) && isset($language_id)) {
			...
			if (empty($language_id)) {
				$selectArr[]= 'before_login_title'.' as before_login_title ';
				$selectArr[]= 'before_login_content'.' as before_login_content ';
				$selectArr[]= 'customer_login_title'.' as customer_login_title ';
				$selectArr[]= 'customer_login_content'.' as customer_login_content ';
				$selectArr[]= 'freelancer_login_title'.' as freelancer_login_title ';
				$selectArr[]= 'freelancer_login_content'.' as freelancer_login_content ';
			} else {
				$selectArr[] = "before_login_title_".$language_id.' as before_login_title ';
				$selectArr[] = "before_login_content_".$language_id.' as before_login_content ';
				$selectArr[] = "customer_login_title_".$language_id.' as customer_login_title ';
				$selectArr[] = "customer_login_content_".$language_id.' as customer_login_content ';
				$selectArr[] = "freelancer_login_title_".$language_id.' as freelancer_login_title ';
				$selectArr[] = "freelancer_login_content_".$language_id.' as freelancer_login_content ';
			}
			$selectArr = implode(",", $selectArr);
			$qrySel = $db->pdoQuery("select ".$selectArr." from tbl_search_section where id=? ",array($id))->result();
	...
	$mainObject = new SearchSection($module, $id, NULL, $searchArray, $action);
