...
include(DIR_ADMIN_CLASS."dashboard_constant-sd.lib.php");
$module = "dashboard_constant-sd";
...
$metaTag = getMetaTags(array("description" => "Admin Panel",
    ...
    'author' => AUTHOR));
$breadcrumb = array("Manage Header Content");
...
if ($_SERVER["REQUEST_METHOD"] == "POST" ) 
{
    ...
    /*$lan_con_detail = $db->select("tbl_language_constant","*",array("value"=>$objPost->value))->affectedRows();
    if($lan_con_detail>0)
    {
        $response['error'] = "Value name already exists";
...
$objContent = new HeaderConstant($module);
