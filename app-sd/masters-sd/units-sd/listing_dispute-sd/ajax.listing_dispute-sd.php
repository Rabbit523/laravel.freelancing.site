...
include(DIR_ADMIN_CLASS."listing_dispute-sd.lib.php");
//echo "<pre>";print_r($_REQUEST);exit;
$module = 'listing_dispute-sd';
...
if (isset($_REQUEST['ajaxvalidate']) && $_REQUEST['ajaxvalidate']) {
    ...
    if ($affected_rows && $affected_rows > 0) {
        ...
        echo json_encode(array('type' => 'success', 'message' => "Disputed Listing deleted successfully"));
        exit;
    } else {
        echo json_encode(array('type' => 'error', 'message' => "There seems to be an issue deleting Disputed Listing"));
        exit;
    }
} 
else if ($action == "view") {
...
$mainObject = new Listing_dispute($module, $id, NULL, $searchArray, $action);
