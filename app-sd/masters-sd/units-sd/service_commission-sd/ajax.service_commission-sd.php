...
if (isset($_REQUEST['ajaxvalidate']) && $_REQUEST['ajaxvalidate']) {
    ...
    echo json_encode(array('type' => 'success', 'Service Commission ' . ($value == 'a' ? 'activated ' : 'deactivated ') . 'successfully'));
...
$mainObject = new ServiceCommision($module, $id, NULL, $searchArray, $action);
