...
var FixedHeader = function ( dt, config ) {
	...
	this.s = {
		dt: dt,
		toggle_btn: (($('#menu_toggle').length > 0) ? $('#menu_toggle') : ""),
		position: {
			theadTop: 0,
			tbodyTop: 0,
			tfootTop: 0,
...
$.extend( FixedHeader.prototype, {
	...
	_clone: function ( item, force )
	{
		...
		if ( ! force && itemDom.floating ) {
			...
			// Clone widths
			this._matchWidths( itemDom.placeholder, itemDom.floating.find('thead') );
		}
	},
	...
	_matchWidths: function ( from, to ) {
		$(from).find("th").each(function(index) {
			$(to).find("th").eq(index).css("width", $(from).find("th").eq(index).css("width"));
        });
